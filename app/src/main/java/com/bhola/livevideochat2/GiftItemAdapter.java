...
import com.bhola.livevideochat2.Models.GiftItemModel;
...
public class GiftItemAdapter extends RecyclerView.Adapter<GiftItemAdapter.ViewHolder> {
    ...
    private final List<GiftItemModel> itemList;
    private final Context context;
    private final int selectedItemPosition = VipMembership.selectedCard[0];
